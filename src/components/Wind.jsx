...
function Wind(props) {  
  return (
    <div className="relative flex flex-col justify-center items-center h-full min-w-64 rounded-xl glass pt-4">
      <div className="w-full h-1/2  grid place-items-center">
        <div className=" relative h-[8.5rem] w-[8.5rem] flex justify-center items-center">
          <p className="absolute h-max w-max text-xs text-center p-0 font-semibold top-0">N</p>
          <p className="absolute h-max w-max text-xs text-center p-0 font-semibold left-0">W</p>
          <p className="absolute h-max w-max text-xs text-center p-0 font-semibold bottom-0">E</p>
          <p className="absolute h-max w-max text-xs text-center p-0 font-semibold right-0 pr-1.5">S</p>
          <img src={arrow} className="w-[6.5rem] invert transition-all duration-[2000ms]" style={{ transform: `rotate(${props.data.wind_degree}deg)` }} id={props.Id} />
        </div>
      ...
      <div className="w-full h-1/2 grid grid-row-2 grid-cols-2 place-items-center">
        ...
        <div>
          ...
          <p className="text-sm text-center">{props.data.windchill_c} C</p>
        </div>
        <div>
